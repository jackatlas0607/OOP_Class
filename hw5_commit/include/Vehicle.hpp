...
private:
    ...
    /// Simply generate the random plate number with format AAA-0000 which A is
    /// algebra and 0 is number return a string plate number formatted AAA-0000
    /// which A is algebra and 0 is number
...
public:
    ...
    /// ElectricVehicle. If it not override by the ElectricVehicle, it should
    /// return Vehicle. It's good to separate the vehicle to Vehicle and
    /// ElectricVehicle. \return string. Maybe Vehicle or ElectricVehicle.
